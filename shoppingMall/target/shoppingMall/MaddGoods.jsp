...
<div class="container" style="width: 500px;">
    ...
    <form action="/mAddGoodsServlet" method="post" id="subForm">
        <div class="form-group">
            <label for="gname">商品名称：</label>
            <input type="text" name="gname" class="form-control" id="gname" placeholder="请输入商品名称"/>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="count" class="form-control" id="count" placeholder="请输入商品库存"/>
        </div>
        <hr/>
